...
export const metadata: Metadata = {
  title: "AI Sales Engine Demo — Automated Lead Reactivation",
  description: "Transform your sales process with intelligent lead reactivation and automated prospecting",
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-white">AI Sales Engine</h1>
                  <p className="text-xs text-gray-400">Demo Platform</p>
                </div>
              </div>
